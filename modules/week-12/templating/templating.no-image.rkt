...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname templating.no-image) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
