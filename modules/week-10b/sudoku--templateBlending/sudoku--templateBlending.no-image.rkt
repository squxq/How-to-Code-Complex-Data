...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname sudoku--templateBlending.no-image) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
