...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname sudoku--makingWishList.no-image) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
